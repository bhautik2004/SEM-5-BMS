    ...
    <form method="post" action="update2.php">
        ...
        <div class="input">
            ...
            <select name="gender" id="gender">
                ...
                <option value="Male" <?php if ($arr['gender'] == 'Male') {
                echo "selected";
            }
            ?>>male</option>
                <option value="Female" <?php if ($arr['gender'] == 'Female') {
                echo "selected";
            }
            ?>>female</option>
                <option value="Other" <?php if ($arr['gender'] == 'Other') {
                echo "selected";
            }
            ?>>other</option>
            </select>
        ...
        <div class="input">
            ...
            <select name="nominee_account_type" id="nominee_account_type" class="b">
                ...
                <option <?php if ($arr['nominee_account_type'] == 'Saving') {
                echo "selected";
            }
            ?>>Saving</option>
                <option <?php if ($arr['nominee_account_type'] == 'Current') {
                echo "selected";
            }
            ?>>Current</option>
            </select>
